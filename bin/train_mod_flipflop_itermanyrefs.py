...
parser.add_argument(
    '--read_ref', nargs="+", #default="", metavar='samples', type=Positive(int),
...
def _load_data(args, log):
    ...
    # add multiple instances of last read_data
    for i in range(5): read_data.append(read_data[-1])
...
def main():
    ...
    read_data = ref_read_data[0] # get read_data from first reference
    ...
    for i in range(args.niteration):
        # update refi and change to read_data from next reference
        read_data = ref_read_data[i%len(ref_read_data)]
